...
import { GITHUB_MCP_FEATURE_ID, isHarnessError } from "@pho-agent/protocol";
import type { AgentFeature } from "../features";
import { githubMcpToolByMcpName, type GitHubMcpAllowlistedTool } from "./allowlist";
import type { GitHubMcpRuntime } from "./runtime";

export const GITHUB_MCP_FEATURE_VERSION = "1.0.0";

export function createGitHubMcpFeature(github: GitHubMcpRuntime): AgentFeature {
  return {
