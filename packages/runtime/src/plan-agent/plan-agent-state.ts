...
// Preserve Pho Code's accepted tool policy while the product adapter migrates to
// explicit capability descriptors. The core does not import the product tool.
export const PLAN_WRITE_TOOL_NAMES = ["write", "edit", "move_to_trash"] as const;
