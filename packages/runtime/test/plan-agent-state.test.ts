...
import { ASK_USER_QUESTION_TOOL_NAME, EXECUTE_PLAN_TOOL_NAME, TODO_TOOL_NAME, UPDATE_PLAN_DOCUMENT_TOOL_NAME } from "@pho-agent/protocol";
import {
  ...
  projectSessionPlan,
  writesOffInPlan,
} from "../src/plan-agent/plan-agent-state";

const TRASH_TOOL_NAME = PLAN_WRITE_TOOL_NAMES[2];
